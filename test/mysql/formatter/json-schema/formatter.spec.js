...
ava('JSON Schema formatter: should format array elements correctly.', t => {
  ...
  // fs.writeFileSync(path.join(__dirname, 'expect', 'person.json'), JSON.stringify(person, null, 2));
  // fs.writeFileSync(path.join(__dirname, 'expect', 'pet.json'), JSON.stringify(pet, null, 2));
