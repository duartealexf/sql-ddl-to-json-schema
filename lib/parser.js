...
class Parser {
     ...
     */
    toCompactJson(json) {
        return this.compactFormatter(json !== null && json !== void 0 ? json : this.results);
    }
    /**
    ...
    toJsonSchemaArray(options = {
        ...
        return this.jsonSchemaFormatter(tables !== null && tables !== void 0 ? tables : this.toCompactJson(), options);
    }
    /**
    ...
    toJsonSchemaFiles(outputDir, options = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const schemas = jsonSchemas !== null && jsonSchemas !== void 0 ? jsonSchemas : this.toJsonSchemaArray({
                useRef: options.useRef,
            });
            const filepaths = yield Promise.all(schemas.map((schema) => __awaiter(this, void 0, void 0, function* () {
                if (!schema.$id) {
