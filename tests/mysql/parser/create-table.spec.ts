  ...
  'Parser: Should create test table with all types and options of columns.': {
    queries: [
      ...
      CREATE TABLE person (
        ...
        ssn1 SMALLINT UNSIGNED NULL COMMENT 'SMALLINT UNSIGNED',
        ssn2 TINYINT NULL COMMENT 'TINYINT',
        ssn3 TINYINT UNSIGNED NULL COMMENT 'TINYINT UNSIGNED',
        ssn4 INT NULL COMMENT 'INT',
        ssn5 INT UNSIGNED NULL COMMENT 'INT UNSIGNED',
        ssn6 MEDIUMINT NULL COMMENT 'MEDIUMINT',
        ssn7 MEDIUMINT UNSIGNED NULL COMMENT 'MEDIUMINT UNSIGNED',
        ssn8 BIGINT NULL COMMENT 'BIGINT',
        ssn9 BIGINT(60) UNSIGNED NULL COMMENT 'BIGINT UNSIGNED',
