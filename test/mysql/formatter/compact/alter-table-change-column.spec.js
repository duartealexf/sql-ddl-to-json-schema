...
ava('Compact formatter: Should alter table, changing column.', t => {
  ...
  parser.feed('ALTER TABLE person CHANGE COLUMN weight width TINYINT UNSIGNED ZEROFILL CHARACTER SET latin1 COLLATE latin_ci NULL DEFAULT 42 UNIQUE INVISIBLE WITHOUT SYSTEM VERSIONING FIRST;');
